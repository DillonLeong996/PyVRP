...
import pyvrp.search
from pyvrp.QuantumInspiredGeneticAlgorithm import QuantumInspiredGeneticAlgorithm, QuantumInspiredGeneticAlgorithmParams
from pyvrp.PenaltyManager import PenaltyManager, PenaltyParams
from pyvrp.PopulationQCI import PopulationQCI, PopulationParams
...
class SolveParamsQci:
    ...
    ----------
    genetic
        Quantum-Inspired Genetic algorithm parameters.
    penalty
        Penalty parameters.
    population
    ...
    def __init__(
        self,
        genetic: QuantumInspiredGeneticAlgorithmParams = QuantumInspiredGeneticAlgorithmParams(),
    ...
    def __eq__(self, other: object) -> bool:
        return (
            isinstance(other, SolveParamsQci)
    ...
    def from_file(cls, loc: str | pathlib.Path):
        ...
        return cls(
            QuantumInspiredGeneticAlgorithmParams(**data.get("genetic", {})),
...
def solveqci(
    ...
    pop = PopulationQCI(bpd, params.population)
    init = [
    ...
    algo = QuantumInspiredGeneticAlgorithm(*gen_args)  # type: ignore
